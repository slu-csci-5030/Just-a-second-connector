...
app.use(express.static(path.join(__dirname, 'Just-a-second-connector/front-end/build')));3

// Catch-all route to serve the React app for all other routes
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'Just-a-second-connector/front-end/build', 'index.html'));
});
