...
function Homepage() {
  ...
  const redirectToReferralForm = () => {
    ...
    window.location.href = "/referral-form";
  };
      ...
      <div className="container">
        <nav className="nav-bar">
          ...
          <div className="options">
            ...
            <div className="button">
              <Link to="/ReferralForm" onClick={redirectToReferralForm}>
                Referral Form
              </Link>
            </div>
            <div className="button">
        ...
        {displayBriefing && (
          <div>
            <center>
              <p>
                <b>Just a Second Connector</b>
                <br></br>-Transformative Workforce Academy<br></br>
                Work Briefing: TWA connects people who are involved with the
                Criminal Justice system in some way who need to find a job
                connect with employment opportunities at employers who are
                willing to give them a second chance. They currently track both
                sets of participants in their programs, the jobseekers and the
                employers, through a set of Google Docs. They need a system to
                help match the restrictions both groups require.
              </p>
            </center>
          </div>
        )}
